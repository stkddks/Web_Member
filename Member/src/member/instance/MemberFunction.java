...
public class MemberFunction {
   public void register(BufferedReader input, Connection conn, Statement stmt, int cnt)
   ...
   public void list(Connection conn, Statement stmt) throws SQLException {
   ...
   public void search(BufferedReader input, Connection conn, Statement stmt) throws IOException, SQLException {
   ...
   public void delete(Statement stmt, Connection conn, String session) throws SQLException {
   ...
   public void update(Statement stmt, Connection conn, BufferedReader input, int cnt, String session)
         throws IOException, SQLException {
   ...
   public String login(Statement stmt, BufferedReader input, Connection conn, String session)
         throws IOException, SQLException {
