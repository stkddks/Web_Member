...
public class MemberFunctionMain {
   ...
   public static void main(String[] args) {
      ...
      Statement stmt = null;
      int cnt = 0;
      MemberFunction member = new MemberFunction();      
      ...
      while (true) {
         ...
         if (protocol.equals("R") || protocol.equals("r")) {
            ...
            try {
               member.register(input, conn, stmt, cnt);
            } catch (IOException e) {
               e.printStackTrace();
            } catch (SQLException e) {
               e.printStackTrace();
            ...
            try {
               member.delete(stmt, conn, protocol);
            } catch (SQLException e) {
               e.printStackTrace();
            }
            ...
            try {
               member.update(stmt, conn, input, cnt, session);
            } catch (IOException e) {
               e.printStackTrace();
            } catch (SQLException e) {
               e.printStackTrace();
            ...
            try {
               session = member.login(stmt, input, conn, session);
            } catch (IOException e) {
               e.printStackTrace();
            } catch (SQLException e) {
               e.printStackTrace();
